...
\begin{nproof}
    \begin{enumerate}
        ...
        \begin{align*}
            ...
            \\ &= \frac{1}{g(t)g(x)}\left[\left(f(t)g(x) - f(x)g(x)\right) - \left(f(x)g(t) - f(t)g(t)\right)\right]
        ...
        \end{align*}
        Taking the limit as $t \rightarrow x$ on both sides, we therefore obtain:
        \begin{align*}
            h'(x) = \frac{f'(x)g(x) - f(x)g'(x)}{(g(x))^2}
        \end{align*}
        which was the desired expression. \qed
    \end{enumerate}
\end{nproof}
