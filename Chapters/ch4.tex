...
As an example, consider $X = \RR^+ = (0, \infty)$ and $Y = \RR$. Then, the function:
\begin{align*}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=2]
        ...
        \filldraw[] (-2.25, 0.5) circle (1.5pt);
        ...
        \filldraw[] (0.75, 0.5) circle (1.5pt);
        \draw[fill = white] (1.375, 0.5) circle (1.5pt);
        \filldraw[] (1.375, 1.5) circle (1.5pt);
