...
\begin{figure}[htbp]
    ...
    \caption{A visualation of an interior point. A set $E \subset \RR^2$ is pictured. $p_1$ is an interior point as there exists $N_r(p_1) \subset E$. $p_2$ is not an interior point as there does not exist a neighbourhood of $p_2$ that is entirely contained in $E$ (it is on the boundary). }
    \label{fig6}
\end{figure}
...
\end{theorem}
\begin{nproof}
    Consider a neighbourhood $E = N_r(p) \subseteq X$. 
\end{nproof}
\begin{figure}[htbp]
    \centering
    \begin{tikzpicture}
    ...
    \caption{Visualization of the Sets in Theorem \ref{thm:2.19}}
    \label{fig7}
\end{figure}
